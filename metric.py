...
def alignment_metric(x, y_pred):
    ...
    text_padded, input_lengths, mel_padded, max_len, output_lengths, ctc_text, ctc_text_lengths, speaker_ids = x
    _, mel_out, mel_out_postnet, gate_outputs, alignments = y_pred
